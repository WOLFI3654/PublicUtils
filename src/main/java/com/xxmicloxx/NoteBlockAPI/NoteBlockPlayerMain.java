...
public class NoteBlockPlayerMain  {
	...
	static {
		plugin = new NoteBlockPlayerMain();
	}
    ...
    public void doSync(Runnable r) {
        Bukkit.getServer().getScheduler().runTask(UtilRegistry.getPlugin(), r);
    }

    public void doAsync(Runnable r) {
        Bukkit.getServer().getScheduler().runTaskAsynchronously(UtilRegistry.getPlugin(), r);
    }
